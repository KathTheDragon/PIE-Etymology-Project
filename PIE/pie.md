...
## Word Classes
Verbs are annotated with the form of the 3sg corresponding to their inflection class: [t] for thematic and \*mi-conjugation aorists, [ti] for thematic and \*mi-conjugation presents, [s] for \*h₂e-conjugation aorists, [ey] for \*h₂e-conjugation presents, [o] or [ó] for dentalless middle aorists, [or] or [ór] for dentalless middle presents, [to] or [tó] for dental middle aorists, and [tor] or [tór] for dental middle presents. \
Nouns are annotated with their gender: [m.] for masculine, [f.] for feminine, and [n.] for neuter. It is possible that the contrast betweem [m.] and [f.] (and partially [f.] and [n.]) is secondary, and should be replaced with common and neuter genders, much as in Hittite.

## Dictionary

[B](#§B) - [Bʰ](#§Bʰ) - [D](#§D) - [Dʰ](#§Dʰ) - [G](#§G) -
[Gʰ](#§Gʰ) - [Ǵ](#§Ǵ) - [Ǵʰ](#§Ǵʰ) - [Gʷ](#§Gʷ) - [Gʷʰ](#§Gʷʰ) -
[H₁](#§H₁) - [H₂](#§H₂) - [H₃](#§H₃) - [Hₓ](#§Hₓ) - [K](#§K) -
[Ḱ](#§Ḱ) - [Kʷ](#§Kʷ) - [L](#§L) - [M](#§M) - [N](#§N) -
[P](#§P) - [S](#§S) - [T](#§T) - [W](#§W) - [Y](#§Y)

## <a id="§H₁">H₁</a>

### <a id="h₁e">\*h₁e- "that; _3rd person_" (pron)</a>
Gothic _is_, _ita_ \
Hittite [_asi_ ~ _uni_ ~ _ini_ "that (one)"](../Anatolian/anatolian.md#asi) \
...
### <a id="h₁erk">\*h₁érk/ḱ-i- ~ \*h₁r̩k/ḱ-i- [ey] "to divide" (v)</a>
Latin _ercīscō_ "to divide (an estate)" \
An \*i-present to [\*h₁órk/ḱ-s "has divided"](#h₁ork).

### <a id="h₁erkʷ">\*h₁érkʷ- ~ \*h₁r̩kʷ- [ti] "to sing" (v)</a>
Hittite [_arkuzzi_ "chants"](../Anatolian/anatolian.md#arku) \
...
Hittite [_anta_ "into, inwards", _antan_ "within, inside"](../Anatolian/anatolian.md#anta) \
Latin _endo_ "in, on, to" \
Old Irish _and_ "there" \
It seems likely that the synchronic contrast between Hittite _anta_ and _antan_ (namely, direction vs location) cannot be wholly projected back to PIE; ἔνδον and _and_, reflecting \*h₁n̩dom/n, are both locatival, while _endo_ has both locatival and directional semantics. This suggests that \*h₁n̩do originally had both functions, while \*h₁n̩dom/n was purely locatival. \
\*h₁n̩do is evidently derived from [\*h₁én "in"](#h₁en). The final nasal of \*h₁n̩dom/n cannot be precisely determined, as all languages reflecting it have merged final nasals, so further etymology is impossible.
...
Old Irish _á_ \
Sanskrit _ā́s-_ \
If the Kortlandt effect (\*d > \*h₁ in some environments) is accepted, then this word could be taken as an amphikinetic neuter \*s-stem to \*h₁ed- "eat".

### <a id="h₁or">\*h₁ór- ~ h₁r̩- [s] "to have reached" (v)</a>
Hittite [_āri_ "comes to"](../Anatolian/anatolian.md#ār) \
Sanskrit _ā́rat_ "has met, has reached" \
Derivatives: [\*h₁r̩-sḱé-ti "is reaching"](#h₁rsḱe)

### <a id="h₁orǵʰi">\*h₁órǵʰ-i- ~ \*h₁r̩ǵʰ-i- [c.] "testicle" (n)</a>
Albanian _herdhë_ "testicles" \
Armenian _orji-kʰ_ "testicle" \
Avestan _ərəzi-_ "testicle(s)" \
Greek ὄρχις "testicle" \
Hittite [_arkiyes_ "testicles"](../Anatolian/anatolian.md#ark) \
Middle Irish _uirge_ "testicle" \
Generally reconstructed with \*h₃ because of pervasive \*o-vocalism, but it is undecidable on that basis whether or not _herdhë_ and _uirge_ continue \*h₁o or \*h₃e. Additionally, there is no guarantee that ὄρχις and _orji-kʰ_ continue zero-grade like _ərəzi-_, nor (in my opinion) that \*h₃r̩ǵʰ-i- would fail to show a laryngeal reflex in Armenian and Hittite. Given all of this, I consider \*h₁ and \*o-grade to be the safer reconstruction.

### <a id="h₁orhₓ">\*h₁órhₓ- ~ \*h₁r̩hₓ- [s] "to have washed" (v)</a>
Hittite [_ārri_ "washes"](../Anatolian/anatolian.md#ārr) \
Tocharian A _yär-_ "bathes"

### <a id="h₁ork">\*h₁órk/ḱ- ~ \*h₁r̩k/ḱ- [s] "to have divided" (v)</a>
Hittite [_ārki_ "to cut off"](../Anatolian/anatolian.md#ārk) \
Derivatives: [\*h₁érk/ḱ-y-ey "divides"](#h₁erki)

### <a id="h₁orso">\*h₁órso- [c.] "arse" (n)</a>
Greek ὄρρος "arse" \
Hittite [_arras_ "arse"](../Anatolian/anatolian.md#arra) \
Middle Irish _err_ "back" \< \*h₁erseh₂ \
Proto-Germanic \*arsaz "arse"

### <a id="h₁rsḱe">\*h₁r̩-sḱé- [ti] "to be reaching" (v)</a>
Greek ἔρχομαι "goes, comes" \
Hittite [_arskezzi_ "is coming to"](../Anatolian/anatolian.md#ār) \
...
### <a id="modʰro">\*m(o)dʰro- "blue" (adj)</a>
Hittite [_antara-_](../Anatolian/anatolian.md#antara) \
Slavic \*modrъ
